...
@guest
@if(count($products)>1)
							@foreach($products->chunk(2) as $pro)
<div class="row ">
			...
			@foreach($pro as $key=>$product)
								...
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single">{{$product->name}}</a></h6>							
										</div>
										<div class="mid-2">
									...
									<!--	<div class="add add-2">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="{{$product->id}}" data-name="{{$product->name}}" data-summary="{{$product->description}}" data-price="{{$product->price}}" data-quantity="{{$product->quantity}}" data-image="{{$product->photo}}"><a href="{{ url('cart/'.$product->id) }}">Add to Cart</a></button>
										</div>-->
									<div class="add add-2">
										<button class="btn btn-danger my-cart-btn my-cart-b" ><a href="{{ url('cart/') }}">Add to Cart</a></button>
										</div>
...
<div class="row ">
			...
			@foreach($pro as $key=>$product)
								...
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
									...
									<div class="add add-2">
										<button class="btn btn-danger my-cart-btn my-cart-b" ><a href="{{ url('cart/'.$product->id.'/'.Auth::user()->name) }}">Add to Cart</a></button>
										</div>
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="{{$product->id}}" data-name="{{$product->name}}" data-summary="{{$product->description}}" data-price="{{$product->price}}" data-quantity="1" data-image="{{$product->photo}}">Add to Cart</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
