								...
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
									...
									<div class="mid-1">
										...
										<div class="mid-2">
											...
											<div class="add add-2">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="{{$product->id}}" data-name="{{$product->name}}" data-summary="{{$product->description}}" data-price="{{$product->price}}" data-quantity="{{$product->quantity}}" data-image="{{$product->photo}}">Add to Cart</button>
										</div>
									</div>
									</div>
