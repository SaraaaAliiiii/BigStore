			...
			<div class="header-ri">
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="/care"><img src="images/me1.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										...
										<div class="col-sm-3 w3l">
											<a href="hold"><img src="images/me2.png" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
					 ...
					 <div class="cart" >
					 <a href="/cart"><i class="fa fa-shopping-cart my-cart-icon" class="badge badge-notify my-cart-badge"></i></a>
...
<?php if(count($products)>1): ?>
							<?php $__currentLoopData = $products->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="row ">
							<div class="col-md-3 pro-1">
				
						
			<?php $__currentLoopData = $pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

			
								<div class="col-m">
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
										<img src="<?php echo e($product->photo); ?>" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single"><?php echo e($product->name); ?></a></h6>							
										</div>
										<div class="mid-2">
									...
									<!--	<div class="add add-2">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>" data-summary="<?php echo e($product->description); ?>" data-price="<?php echo e($product->price); ?>" data-quantity="<?php echo e($product->quantity); ?>" data-image="<?php echo e($product->photo); ?>"><a href="<?php echo e(url('cart/'.$product->id)); ?>">Add to Cart</a></button>
										</div>-->
									<div class="add add-2">
										<button class="btn btn-danger my-cart-btn my-cart-b" ><a href="<?php echo e(url('cart/')); ?>">Add to Cart</a></button>
										</div>
...
<div class="row ">
			...
			<?php $__currentLoopData = $pro; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<a href="#" data-toggle="modal" data-target="#myModal" class="offer-img">
									...
									<div class="add add-2">
										<button class="btn btn-danger my-cart-btn my-cart-b" ><a href="<?php echo e(url('cart/'.$product->id.'/'.Auth::user()->name)); ?>">Add to Cart</a></button>
										</div>
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<div class="price_single">
									  <span class="reducedfrom ">$<?php echo e($product->price); ?></span>
									...
									<p class="quick_desc"> Nam liber tempor cum soluta nobis eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim assum. Typi non habent claritatem insitam; es</p>
									 <div class="add-to">
										   <button class="btn btn-danger my-cart-btn my-cart-btn1 " data-id="<?php echo e($product->id); ?>" data-name="<?php echo e($product->name); ?>" data-summary="<?php echo e($product->description); ?>" data-price="<?php echo e($product->price); ?>" data-quantity="1" data-image="<?php echo e($product->photo); ?>">Add to Cart</button>
										</div>
								</div>
								<div class="clearfix"> </div>
							</div>
